...
export default class Login extends Component {
  ...
  render() {
    return (
      <div className="flex justify-center w-[100%] h-[100vh] bg-[#87e8de]">
        <div className="flex flex-col absolute top-[30%] bg-[#e6fffb] shadow-lg border-silver border-[2px] rounded-lg p-5 w-[40%] mobile:w-[90%]">
