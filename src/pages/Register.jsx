...
export default class Register extends Component {
  ...
  render() {
    return (
      <div className="flex justify-center w-[100%] h-[100vh] bg-[#91caff]">
        <div className="flex flex-col absolute top-[20%] shadow-lg border-silver border-[2px] bg-[#e6fffb] rounded-lg p-5 mobile:w-[90%]">
